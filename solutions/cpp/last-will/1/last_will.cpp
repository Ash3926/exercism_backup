...
namespace estate_executor {
    ...
    {
        int    acc_num = zhang::bank_number_part(secret_modifier) + khan::bank_number_part(secret_modifier) + garcia::bank_number_part(secret_modifier);
        return (acc_num);
    }
